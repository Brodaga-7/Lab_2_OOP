...
namespace Lab1_SmartWatch
{
    public class SmartWatch
    {
        ...
        // Властивості
        public Guid Id { get; private set; } // ID (тільки читання)
        public bool IsWaterproof { get; set; } = false; // Авто-властивість
        ...
        public void Charge(int minutes)
        {
            ...
            int chargeAmount = CalculateChargeAmount(minutes); // Виклик приватного методу
        ...
        {
            if (!CanInstallApp()) // Виклик приватного методу
            {
